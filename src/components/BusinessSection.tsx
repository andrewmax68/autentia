    ...
    <section id="per-produttori" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-gray-900 mb-4">Per i Produttori di Qualità</h3>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Fai conoscere i tuoi prodotti artigianali di eccellenza e indica ai consumatori dove trovarli. 
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">Registra i tuoi prodotti artigianali di eccellenza</span>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3"></div>
            ...
            <Button className="mt-6 bg-green-600 hover:bg-green-700">
              Registrati come Produttore di Qualità
            </Button>
          </div>
